...
void TallyServer::handle_cuDeviceGetLuid(void *__args)
{
	...
	CUresult err = cuDeviceGetLuid(&(luid), &(deviceNodeMask), args->dev);
...
void TallyServer::handle_cuDeviceGetTexture1DLinearMaxWidth(void *__args)
{
	...
	CUresult err = cuDeviceGetTexture1DLinearMaxWidth(&(maxWidthInElements), args->format, args->numChannels, args->dev);
...
void TallyServer::handle_cuDeviceComputeCapability(void *__args)
{
	...
	int  major;
	int  minor;
	CUresult err = cuDeviceComputeCapability(&(major), &(minor), args->dev);
...
void TallyServer::handle_cuDeviceGetExecAffinitySupport(void *__args)
{
	...
	int  pi;
	CUresult err = cuDeviceGetExecAffinitySupport(&(pi), args->type, args->dev);
...
void TallyServer::handle_cuCtxCreate_v2(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxCreate_v2(&(pctx), args->flags, args->dev);
...
void TallyServer::handle_cuCtxPopCurrent_v2(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxPopCurrent_v2(&(pctx));
...
void TallyServer::handle_cuCtxGetFlags(void *__args)
{
	...
	unsigned int  flags;
	CUresult err = cuCtxGetFlags(&(flags));
...
void TallyServer::handle_cuCtxGetLimit(void *__args)
{
	...
	size_t  pvalue;
	CUresult err = cuCtxGetLimit(&(pvalue), args->limit);
...
void TallyServer::handle_cuCtxGetCacheConfig(void *__args)
{
	...
	CUresult err = cuCtxGetCacheConfig(&(pconfig));
...
void TallyServer::handle_cuCtxGetSharedMemConfig(void *__args)
{
	...
	CUresult err = cuCtxGetSharedMemConfig(&(pConfig));
...
void TallyServer::handle_cuCtxGetApiVersion(void *__args)
{
	...
	CUresult err = cuCtxGetApiVersion(args->ctx, &(version));
...
void TallyServer::handle_cuCtxGetStreamPriorityRange(void *__args)
{
	...
	CUresult err = cuCtxGetStreamPriorityRange(&(leastPriority), &(greatestPriority));
...
void TallyServer::handle_cuCtxGetExecAffinity(void *__args)
{
	...
	CUresult err = cuCtxGetExecAffinity(&(pExecAffinity), args->type);
...
void TallyServer::handle_cuCtxAttach(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxAttach(&(pctx), args->flags);
...
void TallyServer::handle_cudnnGetProperty(void *__args)
{
	...
	int  value;
	cudnnStatus_t err = cudnnGetProperty(args->type, &(value));
...
void TallyServer::handle_cudnnCreate(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreate(&(handle));
...
void TallyServer::handle_cudnnGetStream(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetStream(args->handle, &(streamId));
...
void TallyServer::handle_cudnnCreateTensorDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateTensorDescriptor(&(tensorDesc));
...
void TallyServer::handle_cudnnGetTensor4dDescriptor(void *__args)
{
	...
	int  hStride;
	int  wStride;
	cudnnStatus_t err = cudnnGetTensor4dDescriptor(args->tensorDesc, &(dataType), &(n), &(c), &(h), &(w), &(nStride), &(cStride), &(hStride), &(wStride));
...
void TallyServer::handle_cudnnGetTensorSizeInBytes(void *__args)
{
	...
	size_t  size;
	cudnnStatus_t err = cudnnGetTensorSizeInBytes(args->tensorDesc, &(size));
...
void TallyServer::handle_cudnnInitTransformDest(void *__args)
{
	...
	cudnnStatus_t err = cudnnInitTransformDest(args->transformDesc, args->srcDesc, args->destDesc, &(destSizeInBytes));
...
void TallyServer::handle_cudnnCreateTensorTransformDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateTensorTransformDescriptor(&(transformDesc));
...
void TallyServer::handle_cudnnCreateFilterDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateFilterDescriptor(&(filterDesc));
...
void TallyServer::handle_cudnnGetFilterSizeInBytes(void *__args)
{
	...
	size_t  size;
	cudnnStatus_t err = cudnnGetFilterSizeInBytes(args->filterDesc, &(size));
...
void TallyServer::handle_cudnnCreatePoolingDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreatePoolingDescriptor(&(poolingDesc));
...
void TallyServer::handle_cudnnCreateActivationDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateActivationDescriptor(&(activationDesc));
...
void TallyServer::handle_cudnnCreateLRNDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateLRNDescriptor(&(normDesc));
...
void TallyServer::handle_cudnnCreateConvolutionDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateConvolutionDescriptor(&(convDesc));
...
void TallyServer::handle_cudnnGetConvolutionForwardWorkspaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetConvolutionForwardWorkspaceSize(args->handle, args->xDesc, args->wDesc, args->convDesc, args->yDesc, args->algo, &(sizeInBytes));
...
void TallyServer::handle_cudnnBackendCreateDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnBackendCreateDescriptor(args->descriptorType, &(descriptor));
...
void TallyServer::handle_cublasGetStream_v2(void *__args)
{
	...
	cudaStream_t streamId;
	cublasStatus_t err = cublasGetStream_v2(args->handle, &(streamId));
...
void TallyServer::handle_cublasGetPointerMode_v2(void *__args)
{
	...
	cublasStatus_t err = cublasGetPointerMode_v2(args->handle, &(mode));
