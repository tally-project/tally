...
void TallyServer::register_api_handler() {
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDSETQUASIRANDOMGENERATORDIMENSIONS] = std::bind(&TallyServer::handle_curandSetQuasiRandomGeneratorDimensions, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETSCRAMBLECONSTANTS32] = std::bind(&TallyServer::handle_curandGetScrambleConstants32, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATENORMALDOUBLE] = std::bind(&TallyServer::handle_curandGenerateNormalDouble, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDCREATEGENERATORHOST] = std::bind(&TallyServer::handle_curandCreateGeneratorHost, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLMEMALLOC] = std::bind(&TallyServer::handle_pncclMemAlloc, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETPROPERTY] = std::bind(&TallyServer::handle_curandGetProperty, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDSETGENERATOROFFSET] = std::bind(&TallyServer::handle_curandSetGeneratorOffset, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETDIRECTIONVECTORS64] = std::bind(&TallyServer::handle_curandGetDirectionVectors64, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDDESTROYGENERATOR] = std::bind(&TallyServer::handle_curandDestroyGenerator, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDCREATEPOISSONDISTRIBUTION] = std::bind(&TallyServer::handle_curandCreatePoissonDistribution, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATESEEDS] = std::bind(&TallyServer::handle_curandGenerateSeeds, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEPOISSON] = std::bind(&TallyServer::handle_curandGeneratePoisson, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEUNIFORM] = std::bind(&TallyServer::handle_curandGenerateUniform, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDDESTROYDISTRIBUTION] = std::bind(&TallyServer::handle_curandDestroyDistribution, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::NCCLMEMFREE] = std::bind(&TallyServer::handle_ncclMemFree, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATE] = std::bind(&TallyServer::handle_curandGenerate, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEPOISSONMETHOD] = std::bind(&TallyServer::handle_curandGeneratePoissonMethod, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDSETGENERATORORDERING] = std::bind(&TallyServer::handle_curandSetGeneratorOrdering, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEBINOMIALMETHOD] = std::bind(&TallyServer::handle_curandGenerateBinomialMethod, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETSCRAMBLECONSTANTS64] = std::bind(&TallyServer::handle_curandGetScrambleConstants64, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEBINOMIAL] = std::bind(&TallyServer::handle_curandGenerateBinomial, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDCREATEGENERATOR] = std::bind(&TallyServer::handle_curandCreateGenerator, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDSETPSEUDORANDOMGENERATORSEED] = std::bind(&TallyServer::handle_curandSetPseudoRandomGeneratorSeed, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDSETSTREAM] = std::bind(&TallyServer::handle_curandSetStream, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLGETLASTERROR] = std::bind(&TallyServer::handle_pncclGetLastError, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATENORMAL] = std::bind(&TallyServer::handle_curandGenerateNormal, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATELONGLONG] = std::bind(&TallyServer::handle_curandGenerateLongLong, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETVERSION] = std::bind(&TallyServer::handle_curandGetVersion, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLCOMMSPLIT] = std::bind(&TallyServer::handle_pncclCommSplit, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATEUNIFORMDOUBLE] = std::bind(&TallyServer::handle_curandGenerateUniformDouble, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGETDIRECTIONVECTORS32] = std::bind(&TallyServer::handle_curandGetDirectionVectors32, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::NCCLCOMMREGISTER] = std::bind(&TallyServer::handle_ncclCommRegister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::NCCLMEMALLOC] = std::bind(&TallyServer::handle_ncclMemAlloc, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::NCCLCOMMDEREGISTER] = std::bind(&TallyServer::handle_ncclCommDeregister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLCOMMREGISTER] = std::bind(&TallyServer::handle_pncclCommRegister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLMEMFREE] = std::bind(&TallyServer::handle_pncclMemFree, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::NCCLCOMMSPLIT] = std::bind(&TallyServer::handle_ncclCommSplit, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATELOGNORMALDOUBLE] = std::bind(&TallyServer::handle_curandGenerateLogNormalDouble, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CURANDGENERATELOGNORMAL] = std::bind(&TallyServer::handle_curandGenerateLogNormal, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::PNCCLCOMMDEREGISTER] = std::bind(&TallyServer::handle_pncclCommDeregister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
...
void TallyServer::handle_curandCreateGenerator(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandCreateGenerator");
	auto args = (struct curandCreateGeneratorArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(curandCreateGeneratorResponse), alignof(curandCreateGeneratorResponse))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<curandCreateGeneratorResponse*>(responsePayload);
            response->err = curandCreateGenerator(
				(args->generator ? &(response->generator) : NULL),
				args->rng_type
			);
...
void TallyServer::handle_curandCreateGeneratorHost(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandCreateGeneratorHost");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandDestroyGenerator(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandDestroyGenerator");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetVersion(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetVersion");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetProperty(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetProperty");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandSetStream(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandSetStream");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandSetPseudoRandomGeneratorSeed(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandSetPseudoRandomGeneratorSeed");
	auto args = (struct curandSetPseudoRandomGeneratorSeedArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(curandStatus_t), alignof(curandStatus_t))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<curandStatus_t*>(responsePayload);
            *response = curandSetPseudoRandomGeneratorSeed(
				args->generator,
				args->seed
            );
...
void TallyServer::handle_curandSetGeneratorOffset(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandSetGeneratorOffset");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandSetGeneratorOrdering(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandSetGeneratorOrdering");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandSetQuasiRandomGeneratorDimensions(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandSetQuasiRandomGeneratorDimensions");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerate(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerate");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateLongLong(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateLongLong");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateUniform(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateUniform");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateUniformDouble(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateUniformDouble");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateNormal(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateNormal");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateNormalDouble(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateNormalDouble");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateLogNormal(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateLogNormal");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateLogNormalDouble(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateLogNormalDouble");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandCreatePoissonDistribution(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandCreatePoissonDistribution");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandDestroyDistribution(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandDestroyDistribution");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGeneratePoisson(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGeneratePoisson");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGeneratePoissonMethod(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGeneratePoissonMethod");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateBinomial(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateBinomial");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateBinomialMethod(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateBinomialMethod");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGenerateSeeds(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGenerateSeeds");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetDirectionVectors32(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetDirectionVectors32");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetScrambleConstants32(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetScrambleConstants32");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetDirectionVectors64(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetDirectionVectors64");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_curandGetScrambleConstants64(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: curandGetScrambleConstants64");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_ncclMemAlloc(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: ncclMemAlloc");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_pncclMemAlloc(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclMemAlloc");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_ncclMemFree(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: ncclMemFree");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_pncclMemFree(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclMemFree");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
...
void TallyServer::handle_ncclCommAbort(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclCommAbortArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(ncclResult_t), alignof(ncclResult_t))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<ncclResult_t*>(responsePayload);
            *response = ncclCommAbort(
				args->comm
            );
...
void TallyServer::handle_ncclCommSplit(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: ncclCommSplit");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_pncclCommSplit(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclCommSplit");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
...
void TallyServer::handle_pncclGetLastError(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclGetLastError");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_ncclCommGetAsyncError(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclCommGetAsyncErrorArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(ncclCommGetAsyncErrorResponse), alignof(ncclCommGetAsyncErrorResponse))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<ncclCommGetAsyncErrorResponse*>(responsePayload);
            response->err = ncclCommGetAsyncError(
				args->comm,
				(args->asyncError ? &(response->asyncError) : NULL)
			);
...
void TallyServer::handle_ncclBcast(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclBcastArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);
...
void TallyServer::handle_ncclAllGather(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclAllGatherArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);
...
void TallyServer::handle_ncclGroupStart(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclGroupStartArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(ncclResult_t), alignof(ncclResult_t))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<ncclResult_t*>(responsePayload);
            *response = ncclGroupStart(
...
void TallyServer::handle_ncclGroupEnd(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	...
	auto args = (struct ncclGroupEndArg *) __args;
	auto requestHeader = iox::popo::RequestHeader::fromPayload(requestPayload);

    iox_server->loan(requestHeader, sizeof(ncclResult_t), alignof(ncclResult_t))
        .and_then([&](auto& responsePayload) {
            auto response = static_cast<ncclResult_t*>(responsePayload);
            *response = ncclGroupEnd(
...
void TallyServer::handle_ncclCommRegister(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: ncclCommRegister");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_pncclCommRegister(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclCommRegister");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_ncclCommDeregister(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: ncclCommDeregister");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_pncclCommDeregister(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: pncclCommDeregister");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
