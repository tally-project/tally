...
void TallyServer::register_api_handler() {
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHINSTANTIATE_V2] = std::bind(&TallyServer::handle_cuGraphInstantiate_v2, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMWAITVALUE32] = std::bind(&TallyServer::handle_cuStreamWaitValue32, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMBATCHMEMOP] = std::bind(&TallyServer::handle_cuStreamBatchMemOp, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDABINDTEXTURETOMIPMAPPEDARRAY] = std::bind(&TallyServer::handle_cudaBindTextureToMipmappedArray, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAPROFILERINITIALIZE] = std::bind(&TallyServer::handle_cudaProfilerInitialize, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMWRITEVALUE32] = std::bind(&TallyServer::handle_cuStreamWriteValue32, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDABINDSURFACETOARRAY] = std::bind(&TallyServer::handle_cudaBindSurfaceToArray, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAUNBINDTEXTURE] = std::bind(&TallyServer::handle_cudaUnbindTexture, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAGETTEXTUREALIGNMENTOFFSET] = std::bind(&TallyServer::handle_cudaGetTextureAlignmentOffset, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMWRITEVALUE64] = std::bind(&TallyServer::handle_cuStreamWriteValue64, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGETPROCADDRESS] = std::bind(&TallyServer::handle_cuGetProcAddress, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHKERNELNODEGETPARAMS] = std::bind(&TallyServer::handle_cuGraphKernelNodeGetParams, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	cuda_api_handler_map[CUDA_API_ENUM::CUDABINDTEXTURE] = std::bind(&TallyServer::handle_cudaBindTexture, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHADDKERNELNODE] = std::bind(&TallyServer::handle_cuGraphAddKernelNode, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAGETDEVICEPROPERTIES] = std::bind(&TallyServer::handle_cudaGetDeviceProperties, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAGETTEXTUREREFERENCE] = std::bind(&TallyServer::handle_cudaGetTextureReference, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMGETCAPTUREINFO] = std::bind(&TallyServer::handle_cuStreamGetCaptureInfo, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDAGETSURFACEREFERENCE] = std::bind(&TallyServer::handle_cudaGetSurfaceReference, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDABINDTEXTURETOARRAY] = std::bind(&TallyServer::handle_cudaBindTextureToArray, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUSTREAMWAITVALUE64] = std::bind(&TallyServer::handle_cuStreamWaitValue64, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDABINDTEXTURE2D] = std::bind(&TallyServer::handle_cudaBindTexture2D, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHEXECKERNELNODESETPARAMS] = std::bind(&TallyServer::handle_cuGraphExecKernelNodeSetParams, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUDASTREAMGETCAPTUREINFO] = std::bind(&TallyServer::handle_cudaStreamGetCaptureInfo, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHEXECUPDATE] = std::bind(&TallyServer::handle_cuGraphExecUpdate, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	...
	cuda_api_handler_map[CUDA_API_ENUM::CUGRAPHKERNELNODESETPARAMS] = std::bind(&TallyServer::handle_cuGraphKernelNodeSetParams, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
...
void TallyServer::handle_cuStreamGetCaptureInfo(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuStreamWaitValue32(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuStreamWaitValue32");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuStreamWaitValue64(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuStreamWaitValue64");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuStreamWriteValue32(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuStreamWriteValue32");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuStreamWriteValue64(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuStreamWriteValue64");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuStreamBatchMemOp(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuGraphAddKernelNode(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuGraphAddKernelNode");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuGraphKernelNodeGetParams(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cuGraphKernelNodeGetParams");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cuGraphKernelNodeSetParams(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuGraphInstantiate_v2(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuGraphExecKernelNodeSetParams(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuGraphExecUpdate(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cuGetProcAddress(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cudaGetDeviceProperties(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cudaStreamGetCaptureInfo(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cudaBindTexture(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaBindTexture");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaBindTexture2D(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaBindTexture2D");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaBindTextureToArray(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaBindTextureToArray");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaBindTextureToMipmappedArray(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaBindTextureToMipmappedArray");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaUnbindTexture(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaUnbindTexture");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaGetTextureAlignmentOffset(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaGetTextureAlignmentOffset");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaGetTextureReference(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaGetTextureReference");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaBindSurfaceToArray(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
	TALLY_SPD_LOG("Received request: cudaBindSurfaceToArray");
	throw std::runtime_error(std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": Unimplemented.");
}
void TallyServer::handle_cudaGetSurfaceReference(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
...
void TallyServer::handle_cudaProfilerInitialize(void *__args, iox::popo::UntypedServer *iox_server, const void* const requestPayload)
{
