...
void TallyServer::handle_cuDriverGetVersion(void *__args)
{
	...
	int  driverVersion;
	CUresult err = cuDriverGetVersion((args->driverVersion ? &(driverVersion) : NULL));
...
void TallyServer::handle_cuDeviceGet(void *__args)
{
	...
	CUdevice  device;
	CUresult err = cuDeviceGet((args->device ? &(device) : NULL), args->ordinal);
...
void TallyServer::handle_cuDeviceGetCount(void *__args)
{
	...
	int  count;
	CUresult err = cuDeviceGetCount((args->count ? &(count) : NULL));
...
void TallyServer::handle_cuDeviceGetUuid(void *__args)
{
	...
	CUuuid  uuid;
	CUresult err = cuDeviceGetUuid((args->uuid ? &(uuid) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceGetUuid_v2(void *__args)
{
	...
	CUuuid  uuid;
	CUresult err = cuDeviceGetUuid_v2((args->uuid ? &(uuid) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceGetLuid(void *__args)
{
	...
	CUresult err = cuDeviceGetLuid((args->luid ? &(luid) : NULL), (args->deviceNodeMask ? &(deviceNodeMask) : NULL), args->dev);
	struct cuDeviceGetLuidResponse res {
		luid,
		deviceNodeMask,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuDeviceGetLuidResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuDeviceTotalMem_v2(void *__args)
{
	...
	size_t  bytes;
	CUresult err = cuDeviceTotalMem_v2((args->bytes ? &(bytes) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceGetTexture1DLinearMaxWidth(void *__args)
{
	...
	CUresult err = cuDeviceGetTexture1DLinearMaxWidth((args->maxWidthInElements ? &(maxWidthInElements) : NULL), args->format, args->numChannels, args->dev);
	struct cuDeviceGetTexture1DLinearMaxWidthResponse res {
		maxWidthInElements,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuDeviceGetTexture1DLinearMaxWidthResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuDeviceGetAttribute(void *__args)
{
	...
	int  pi;
	CUresult err = cuDeviceGetAttribute((args->pi ? &(pi) : NULL), args->attrib, args->dev);
...
void TallyServer::handle_cuDeviceGetMemPool(void *__args)
{
	...
	CUmemoryPool  pool;
	CUresult err = cuDeviceGetMemPool((args->pool ? &(pool) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceGetDefaultMemPool(void *__args)
{
	...
	CUresult err = cuDeviceGetDefaultMemPool((args->pool_out ? &(pool_out) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceGetProperties(void *__args)
{
	...
	CUdevprop  prop;
	CUresult err = cuDeviceGetProperties((args->prop ? &(prop) : NULL), args->dev);
...
void TallyServer::handle_cuDeviceComputeCapability(void *__args)
{
	...
	int  major;
	int  minor;
	CUresult err = cuDeviceComputeCapability((args->major ? &(major) : NULL), (args->minor ? &(minor) : NULL), args->dev);
	struct cuDeviceComputeCapabilityResponse res {
		major,
		minor,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuDeviceComputeCapabilityResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuDevicePrimaryCtxRetain(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuDevicePrimaryCtxRetain((args->pctx ? &(pctx) : NULL), args->dev);
...
void TallyServer::handle_cuDevicePrimaryCtxGetState(void *__args)
{
	...
	unsigned int  flags;
	int  active;
	CUresult err = cuDevicePrimaryCtxGetState(args->dev, (args->flags ? &(flags) : NULL), (args->active ? &(active) : NULL));
...
void TallyServer::handle_cuDeviceGetExecAffinitySupport(void *__args)
{
	...
	int  pi;
	CUresult err = cuDeviceGetExecAffinitySupport((args->pi ? &(pi) : NULL), args->type, args->dev);
	struct cuDeviceGetExecAffinitySupportResponse res {
		pi,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuDeviceGetExecAffinitySupportResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxCreate_v2(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxCreate_v2((args->pctx ? &(pctx) : NULL), args->flags, args->dev);
	struct cuCtxCreate_v2Response res {
		pctx,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxCreate_v2Response))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxPushCurrent_v2(void *__args)
{
    ...
    CUresult err = cuCtxPushCurrent_v2(
		args->ctx
...
void TallyServer::handle_cuCtxPopCurrent_v2(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxPopCurrent_v2((args->pctx ? &(pctx) : NULL));
	struct cuCtxPopCurrent_v2Response res {
		pctx,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxPopCurrent_v2Response))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetCurrent(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxGetCurrent((args->pctx ? &(pctx) : NULL));
	struct cuCtxGetCurrentResponse res {
		pctx,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetCurrentResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetDevice(void *__args)
{
	...
	CUdevice  device;
	CUresult err = cuCtxGetDevice((args->device ? &(device) : NULL));
	struct cuCtxGetDeviceResponse res {
		device,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetDeviceResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetFlags(void *__args)
{
	...
	unsigned int  flags;
	CUresult err = cuCtxGetFlags((args->flags ? &(flags) : NULL));
	struct cuCtxGetFlagsResponse res {
		flags,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetFlagsResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetLimit(void *__args)
{
	...
	size_t  pvalue;
	CUresult err = cuCtxGetLimit((args->pvalue ? &(pvalue) : NULL), args->limit);
	struct cuCtxGetLimitResponse res {
		pvalue,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetLimitResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetCacheConfig(void *__args)
{
	...
	CUresult err = cuCtxGetCacheConfig((args->pconfig ? &(pconfig) : NULL));
	struct cuCtxGetCacheConfigResponse res {
		pconfig,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetCacheConfigResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxSetCacheConfig(void *__args)
{
    ...
    CUresult err = cuCtxSetCacheConfig(
		args->config
...
void TallyServer::handle_cuCtxGetSharedMemConfig(void *__args)
{
	...
	CUresult err = cuCtxGetSharedMemConfig((args->pConfig ? &(pConfig) : NULL));
	struct cuCtxGetSharedMemConfigResponse res {
		pConfig,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetSharedMemConfigResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxSetSharedMemConfig(void *__args)
{
    ...
    CUresult err = cuCtxSetSharedMemConfig(
		args->config
...
void TallyServer::handle_cuCtxGetApiVersion(void *__args)
{
	...
	CUresult err = cuCtxGetApiVersion(args->ctx, (args->version ? &(version) : NULL));
	struct cuCtxGetApiVersionResponse res {
		version,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetApiVersionResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxGetStreamPriorityRange(void *__args)
{
	...
	CUresult err = cuCtxGetStreamPriorityRange((args->leastPriority ? &(leastPriority) : NULL), (args->greatestPriority ? &(greatestPriority) : NULL));
	struct cuCtxGetStreamPriorityRangeResponse res {
		leastPriority,
		greatestPriority,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetStreamPriorityRangeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxResetPersistingL2Cache(void *__args)
{
    ...
    CUresult err = cuCtxResetPersistingL2Cache(
...
void TallyServer::handle_cuCtxGetExecAffinity(void *__args)
{
	...
	CUresult err = cuCtxGetExecAffinity((args->pExecAffinity ? &(pExecAffinity) : NULL), args->type);
	struct cuCtxGetExecAffinityResponse res {
		pExecAffinity,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxGetExecAffinityResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuCtxAttach(void *__args)
{
	...
	CUcontext  pctx;
	CUresult err = cuCtxAttach((args->pctx ? &(pctx) : NULL), args->flags);
	struct cuCtxAttachResponse res {
		pctx,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuCtxAttachResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuMemAllocFromPoolAsync(void *__args)
{
	...
	CUdeviceptr  dptr;
	CUresult err = cuMemAllocFromPoolAsync((args->dptr ? &(dptr) : NULL), args->bytesize, args->pool, args->hStream);
	struct cuMemAllocFromPoolAsyncResponse res {
		dptr,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cuMemAllocFromPoolAsyncResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cuDestroyExternalMemory(void *__args)
{
    ...
    CUresult err = cuDestroyExternalMemory(
		args->extMem
...
void TallyServer::handle_cudaDeviceGetLimit(void *__args)
{
	...
	size_t  pValue;
	cudaError_t err = cudaDeviceGetLimit((args->pValue ? &(pValue) : NULL), args->limit);
...
void TallyServer::handle_cudaDeviceGetCacheConfig(void *__args)
{
	...
	cudaError_t err = cudaDeviceGetCacheConfig((args->pCacheConfig ? &(pCacheConfig) : NULL));
...
void TallyServer::handle_cudaDeviceGetStreamPriorityRange(void *__args)
{
	...
	int  leastPriority;
	int  greatestPriority;
	cudaError_t err = cudaDeviceGetStreamPriorityRange((args->leastPriority ? &(leastPriority) : NULL), (args->greatestPriority ? &(greatestPriority) : NULL));
...
void TallyServer::handle_cudaDeviceGetPCIBusId(void *__args)
{
	...
	char  pciBusId;
	cudaError_t err = cudaDeviceGetPCIBusId((args->pciBusId ? &(pciBusId) : NULL), args->len, args->device);
	struct cudaDeviceGetPCIBusIdResponse res {
		pciBusId,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaDeviceGetPCIBusIdResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaIpcGetEventHandle(void *__args)
{
	...
	cudaError_t err = cudaIpcGetEventHandle((args->handle ? &(handle) : NULL), args->event);
	struct cudaIpcGetEventHandleResponse res {
		handle,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaIpcGetEventHandleResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaIpcOpenEventHandle(void *__args)
{
	...
	cudaEvent_t  event;
	cudaError_t err = cudaIpcOpenEventHandle((args->event ? &(event) : NULL), args->handle);
...
void TallyServer::handle_cudaIpcGetMemHandle(void *__args)
{
	...
	cudaError_t err = cudaIpcGetMemHandle((args->handle ? &(handle) : NULL), args->devPtr);
	struct cudaIpcGetMemHandleResponse res {
		handle,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaIpcGetMemHandleResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaIpcOpenMemHandle(void *__args)
{
	...
	void * devPtr;
	cudaError_t err = cudaIpcOpenMemHandle((args->devPtr ? &(devPtr) : NULL), args->handle, args->flags);
	struct cudaIpcOpenMemHandleResponse res {
		devPtr,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaIpcOpenMemHandleResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaIpcCloseMemHandle(void *__args)
{
    ...
    cudaError_t err = cudaIpcCloseMemHandle(
		args->devPtr
...
void TallyServer::handle_cudaDeviceFlushGPUDirectRDMAWrites(void *__args)
{
    ...
    cudaError_t err = cudaDeviceFlushGPUDirectRDMAWrites(
		args->target,
		args->scope
...
void TallyServer::handle_cudaThreadGetLimit(void *__args)
{
	...
	size_t  pValue;
	cudaError_t err = cudaThreadGetLimit((args->pValue ? &(pValue) : NULL), args->limit);
...
void TallyServer::handle_cudaThreadGetCacheConfig(void *__args)
{
	...
	enum cudaFuncCache  pCacheConfig;
	cudaError_t err = cudaThreadGetCacheConfig((args->pCacheConfig ? &(pCacheConfig) : NULL));
...
void TallyServer::handle_cudaGetDeviceCount(void *__args)
{
	...
	int  count;
	cudaError_t err = cudaGetDeviceCount((args->count ? &(count) : NULL));
...
void TallyServer::handle_cudaGetDeviceProperties(void *__args)
{
	...
	cudaError_t err = cudaGetDeviceProperties((args->prop ? &(prop) : NULL), args->device);
...
void TallyServer::handle_cudaDeviceGetAttribute(void *__args)
{
	...
	int  value;
	cudaError_t err = cudaDeviceGetAttribute((args->value ? &(value) : NULL), args->attr, args->device);
...
void TallyServer::handle_cudaDeviceGetDefaultMemPool(void *__args)
{
	...
	cudaError_t err = cudaDeviceGetDefaultMemPool((args->memPool ? &(memPool) : NULL), args->device);
...
void TallyServer::handle_cudaDeviceGetMemPool(void *__args)
{
	...
	cudaMemPool_t  memPool;
	cudaError_t err = cudaDeviceGetMemPool((args->memPool ? &(memPool) : NULL), args->device);
...
void TallyServer::handle_cudaDeviceGetP2PAttribute(void *__args)
{
	...
	int  value;
	cudaError_t err = cudaDeviceGetP2PAttribute((args->value ? &(value) : NULL), args->attr, args->srcDevice, args->dstDevice);
...
void TallyServer::handle_cudaGetDevice(void *__args)
{
	...
	int  device;
	cudaError_t err = cudaGetDevice((args->device ? &(device) : NULL));
...
void TallyServer::handle_cudaGetDeviceFlags(void *__args)
{
	...
	unsigned int  flags;
	cudaError_t err = cudaGetDeviceFlags((args->flags ? &(flags) : NULL));
...
void TallyServer::handle_cudaStreamCreate(void *__args)
{
	...
	cudaError_t err = cudaStreamCreate((args->pStream ? &(pStream) : NULL));
...
void TallyServer::handle_cudaStreamCreateWithFlags(void *__args)
{
	...
	cudaStream_t  pStream;
	cudaError_t err = cudaStreamCreateWithFlags((args->pStream ? &(pStream) : NULL), args->flags);
...
void TallyServer::handle_cudaStreamCreateWithPriority(void *__args)
{
	...
	cudaStream_t  pStream;
	cudaError_t err = cudaStreamCreateWithPriority((args->pStream ? &(pStream) : NULL), args->flags, args->priority);
...
void TallyServer::handle_cudaStreamGetPriority(void *__args)
{
	...
	int  priority;
	cudaError_t err = cudaStreamGetPriority(args->hStream, (args->priority ? &(priority) : NULL));
	struct cudaStreamGetPriorityResponse res {
		priority,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaStreamGetPriorityResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaStreamGetFlags(void *__args)
{
	...
	unsigned int  flags;
	cudaError_t err = cudaStreamGetFlags(args->hStream, (args->flags ? &(flags) : NULL));
	struct cudaStreamGetFlagsResponse res {
		flags,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaStreamGetFlagsResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaStreamIsCapturing(void *__args)
{
	...
	cudaError_t err = cudaStreamIsCapturing(args->stream, (args->pCaptureStatus ? &(pCaptureStatus) : NULL));
...
void TallyServer::handle_cudaStreamGetCaptureInfo(void *__args)
{
	...
	cudaError_t err = cudaStreamGetCaptureInfo(args->stream, (args->pCaptureStatus ? &(pCaptureStatus) : NULL), (args->pId ? &(pId) : NULL));
	struct cudaStreamGetCaptureInfoResponse res {
		pCaptureStatus,
		pId,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaStreamGetCaptureInfoResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaEventCreate(void *__args)
{
	...
	cudaEvent_t  event;
	cudaError_t err = cudaEventCreate((args->event ? &(event) : NULL));
...
void TallyServer::handle_cudaEventCreateWithFlags(void *__args)
{
	...
	cudaEvent_t  event;
	cudaError_t err = cudaEventCreateWithFlags((args->event ? &(event) : NULL), args->flags);
...
void TallyServer::handle_cudaEventElapsedTime(void *__args)
{
	...
	float  ms;
	cudaError_t err = cudaEventElapsedTime((args->ms ? &(ms) : NULL), args->start, args->end);
...
void TallyServer::handle_cudaMemGetInfo(void *__args)
{
	...
	size_t  free;
	size_t  total;
	cudaError_t err = cudaMemGetInfo((args->free ? &(free) : NULL), (args->total ? &(total) : NULL));
	struct cudaMemGetInfoResponse res {
		free,
		total,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudaMemGetInfoResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudaGraphCreate(void *__args)
{
	...
	cudaGraph_t  pGraph;
	cudaError_t err = cudaGraphCreate((args->pGraph ? &(pGraph) : NULL), args->flags);
...
void TallyServer::handle_cudnnGetMaxDeviceVersion(void *__args)
{
    ...
    size_t err = cudnnGetMaxDeviceVersion(
...
void TallyServer::handle_cudnnGetCudartVersion(void *__args)
{
    ...
    size_t err = cudnnGetCudartVersion(
...
void TallyServer::handle_cudnnGetProperty(void *__args)
{
	...
	int  value;
	cudnnStatus_t err = cudnnGetProperty(args->type, (args->value ? &(value) : NULL));
	struct cudnnGetPropertyResponse res {
		value,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetPropertyResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreate(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreate((args->handle ? &(handle) : NULL));
	struct cudnnCreateResponse res {
		handle,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroy(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroy(
		args->handle
...
void TallyServer::handle_cudnnSetStream(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetStream(
		args->handle,
		args->streamId
...
void TallyServer::handle_cudnnGetStream(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetStream(args->handle, (args->streamId ? &(streamId) : NULL));
	struct cudnnGetStreamResponse res {
		streamId,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetStreamResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreateTensorDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateTensorDescriptor((args->tensorDesc ? &(tensorDesc) : NULL));
	struct cudnnCreateTensorDescriptorResponse res {
		tensorDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateTensorDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnSetTensor4dDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetTensor4dDescriptor(
		args->tensorDesc,
		args->format,
		args->dataType,
		args->n,
...
void TallyServer::handle_cudnnGetTensor4dDescriptor(void *__args)
{
	...
	int  hStride;
	int  wStride;
	cudnnStatus_t err = cudnnGetTensor4dDescriptor(args->tensorDesc, (args->dataType ? &(dataType) : NULL), (args->n ? &(n) : NULL), (args->c ? &(c) : NULL), (args->h ? &(h) : NULL), (args->w ? &(w) : NULL), (args->nStride ? &(nStride) : NULL), (args->cStride ? &(cStride) : NULL), (args->hStride ? &(hStride) : NULL), (args->wStride ? &(wStride) : NULL));
	struct cudnnGetTensor4dDescriptorResponse res {
		dataType,
		n,
		c,
		h,
    ...
    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetTensor4dDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetTensorSizeInBytes(void *__args)
{
	...
	size_t  size;
	cudnnStatus_t err = cudnnGetTensorSizeInBytes(args->tensorDesc, (args->size ? &(size) : NULL));
	struct cudnnGetTensorSizeInBytesResponse res {
		size,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetTensorSizeInBytesResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyTensorDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyTensorDescriptor(
		args->tensorDesc
...
void TallyServer::handle_cudnnInitTransformDest(void *__args)
{
	...
	cudnnStatus_t err = cudnnInitTransformDest(args->transformDesc, args->srcDesc, args->destDesc, (args->destSizeInBytes ? &(destSizeInBytes) : NULL));
	struct cudnnInitTransformDestResponse res {
		destSizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnInitTransformDestResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreateTensorTransformDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateTensorTransformDescriptor((args->transformDesc ? &(transformDesc) : NULL));
	struct cudnnCreateTensorTransformDescriptorResponse res {
		transformDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateTensorTransformDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyTensorTransformDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyTensorTransformDescriptor(
		args->transformDesc
...
void TallyServer::handle_cudnnCreateOpTensorDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateOpTensorDescriptor((args->opTensorDesc ? &(opTensorDesc) : NULL));
	struct cudnnCreateOpTensorDescriptorResponse res {
		opTensorDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateOpTensorDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnSetOpTensorDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetOpTensorDescriptor(
		args->opTensorDesc,
		args->opTensorOp,
...
void TallyServer::handle_cudnnGetOpTensorDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetOpTensorDescriptor(args->opTensorDesc, (args->opTensorOp ? &(opTensorOp) : NULL), (args->opTensorCompType ? &(opTensorCompType) : NULL), (args->opTensorNanOpt ? &(opTensorNanOpt) : NULL));
	struct cudnnGetOpTensorDescriptorResponse res {
		opTensorOp,
		opTensorCompType,
		opTensorNanOpt,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetOpTensorDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreateFilterDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateFilterDescriptor((args->filterDesc ? &(filterDesc) : NULL));
	struct cudnnCreateFilterDescriptorResponse res {
		filterDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateFilterDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetFilterSizeInBytes(void *__args)
{
	...
	size_t  size;
	cudnnStatus_t err = cudnnGetFilterSizeInBytes(args->filterDesc, (args->size ? &(size) : NULL));
	struct cudnnGetFilterSizeInBytesResponse res {
		size,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetFilterSizeInBytesResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyFilterDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyFilterDescriptor(
		args->filterDesc
...
void TallyServer::handle_cudnnCreatePoolingDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreatePoolingDescriptor((args->poolingDesc ? &(poolingDesc) : NULL));
	struct cudnnCreatePoolingDescriptorResponse res {
		poolingDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreatePoolingDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyPoolingDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyPoolingDescriptor(
		args->poolingDesc
...
void TallyServer::handle_cudnnCreateActivationDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateActivationDescriptor((args->activationDesc ? &(activationDesc) : NULL));
	struct cudnnCreateActivationDescriptorResponse res {
		activationDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateActivationDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnSetActivationDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetActivationDescriptor(
		args->activationDesc,
		args->mode,
		args->reluNanOpt,
		args->coef
...
void TallyServer::handle_cudnnDestroyActivationDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyActivationDescriptor(
		args->activationDesc
...
void TallyServer::handle_cudnnCreateLRNDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateLRNDescriptor((args->normDesc ? &(normDesc) : NULL));
	struct cudnnCreateLRNDescriptorResponse res {
		normDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateLRNDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnSetLRNDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetLRNDescriptor(
		args->normDesc,
		args->lrnN,
		args->lrnAlpha,
		args->lrnBeta,
...
void TallyServer::handle_cudnnDestroyLRNDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyLRNDescriptor(
		args->lrnDesc
...
void TallyServer::handle_cudnnCreateDropoutDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateDropoutDescriptor((args->dropoutDesc ? &(dropoutDesc) : NULL));
	struct cudnnCreateDropoutDescriptorResponse res {
		dropoutDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateDropoutDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyDropoutDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyDropoutDescriptor(
		args->dropoutDesc
...
void TallyServer::handle_cudnnDropoutGetStatesSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnDropoutGetStatesSize(args->handle, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnDropoutGetStatesSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnDropoutGetStatesSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnRestoreDropoutDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRestoreDropoutDescriptor(
		args->dropoutDesc,
		args->handle,
		args->dropout,
		args->states,
...
void TallyServer::handle_cudnnOpsInferVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnOpsInferVersionCheck(
...
void TallyServer::handle_cudnnGetBatchNormalizationForwardTrainingExWorkspaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetBatchNormalizationForwardTrainingExWorkspaceSize(args->handle, args->mode, args->bnOps, args->xDesc, args->zDesc, args->yDesc, args->bnScaleBiasMeanVarDesc, args->activationDesc, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnGetBatchNormalizationForwardTrainingExWorkspaceSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetBatchNormalizationForwardTrainingExWorkspaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetBatchNormalizationBackwardExWorkspaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetBatchNormalizationBackwardExWorkspaceSize(args->handle, args->mode, args->bnOps, args->xDesc, args->yDesc, args->dyDesc, args->dzDesc, args->dxDesc, args->dBnScaleBiasDesc, args->activationDesc, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnGetBatchNormalizationBackwardExWorkspaceSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetBatchNormalizationBackwardExWorkspaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetBatchNormalizationTrainingExReserveSpaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetBatchNormalizationTrainingExReserveSpaceSize(args->handle, args->mode, args->bnOps, args->activationDesc, args->xDesc, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnGetBatchNormalizationTrainingExReserveSpaceSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetBatchNormalizationTrainingExReserveSpaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnOpsTrainVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnOpsTrainVersionCheck(
...
void TallyServer::handle_cudnnCreateRNNDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateRNNDescriptor((args->rnnDesc ? &(rnnDesc) : NULL));
	struct cudnnCreateRNNDescriptorResponse res {
		rnnDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateRNNDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyRNNDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyRNNDescriptor(
		args->rnnDesc
...
void TallyServer::handle_cudnnSetRNNDescriptor_v8(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetRNNDescriptor_v8(
		args->rnnDesc,
		args->algo,
		args->cellMode,
		args->biasMode,
...
void TallyServer::handle_cudnnSetRNNDescriptor_v6(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetRNNDescriptor_v6(
		args->handle,
		args->rnnDesc,
		args->hiddenSize,
		args->numLayers,
...
void TallyServer::handle_cudnnSetRNNMatrixMathType(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetRNNMatrixMathType(
		args->rnnDesc,
		args->mType
...
void TallyServer::handle_cudnnGetRNNMatrixMathType(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetRNNMatrixMathType(args->rnnDesc, (args->mType ? &(mType) : NULL));
	struct cudnnGetRNNMatrixMathTypeResponse res {
		mType,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNMatrixMathTypeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnSetRNNBiasMode(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetRNNBiasMode(
		args->rnnDesc,
		args->biasMode
...
void TallyServer::handle_cudnnGetRNNBiasMode(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetRNNBiasMode(args->rnnDesc, (args->biasMode ? &(biasMode) : NULL));
	struct cudnnGetRNNBiasModeResponse res {
		biasMode,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNBiasModeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnRNNSetClip_v8(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRNNSetClip_v8(
		args->rnnDesc,
		args->clipMode,
		args->clipNanOpt,
		args->lclip,
...
void TallyServer::handle_cudnnRNNSetClip(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRNNSetClip(
		args->handle,
		args->rnnDesc,
		args->clipMode,
		args->clipNanOpt,
...
void TallyServer::handle_cudnnBuildRNNDynamic(void *__args)
{
    ...
    cudnnStatus_t err = cudnnBuildRNNDynamic(
		args->handle,
		args->rnnDesc,
		args->miniBatch
...
void TallyServer::handle_cudnnGetRNNTempSpaceSizes(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetRNNTempSpaceSizes(args->handle, args->rnnDesc, args->fMode, args->xDesc, (args->workSpaceSize ? &(workSpaceSize) : NULL), (args->reserveSpaceSize ? &(reserveSpaceSize) : NULL));
	struct cudnnGetRNNTempSpaceSizesResponse res {
		workSpaceSize,
		reserveSpaceSize,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNTempSpaceSizesResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetRNNParamsSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetRNNParamsSize(args->handle, args->rnnDesc, args->xDesc, (args->sizeInBytes ? &(sizeInBytes) : NULL), args->dataType);
	struct cudnnGetRNNParamsSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNParamsSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetRNNWeightSpaceSize(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetRNNWeightSpaceSize(args->handle, args->rnnDesc, (args->weightSpaceSize ? &(weightSpaceSize) : NULL));
	struct cudnnGetRNNWeightSpaceSizeResponse res {
		weightSpaceSize,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNWeightSpaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetRNNLinLayerMatrixParams(void *__args)
{
	...
	void * linLayerMat;
	cudnnStatus_t err = cudnnGetRNNLinLayerMatrixParams(args->handle, args->rnnDesc, args->pseudoLayer, args->xDesc, args->wDesc, args->w, args->linLayerID, args->linLayerMatDesc, (args->linLayerMat ? &(linLayerMat) : NULL));
	struct cudnnGetRNNLinLayerMatrixParamsResponse res {
		linLayerMat,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNLinLayerMatrixParamsResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetRNNLinLayerBiasParams(void *__args)
{
	...
	void * linLayerBias;
	cudnnStatus_t err = cudnnGetRNNLinLayerBiasParams(args->handle, args->rnnDesc, args->pseudoLayer, args->xDesc, args->wDesc, args->w, args->linLayerID, args->linLayerBiasDesc, (args->linLayerBias ? &(linLayerBias) : NULL));
	struct cudnnGetRNNLinLayerBiasParamsResponse res {
		linLayerBias,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNLinLayerBiasParamsResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetRNNWeightParams(void *__args)
{
	...
	void * mAddr;
	void * bAddr;
	cudnnStatus_t err = cudnnGetRNNWeightParams(args->handle, args->rnnDesc, args->pseudoLayer, args->weightSpaceSize, args->weightSpace, args->linLayerID, args->mDesc, (args->mAddr ? &(mAddr) : NULL), args->bDesc, (args->bAddr ? &(bAddr) : NULL));
	struct cudnnGetRNNWeightParamsResponse res {
		mAddr,
		bAddr,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNWeightParamsResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreateRNNDataDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateRNNDataDescriptor((args->rnnDataDesc ? &(rnnDataDesc) : NULL));
	struct cudnnCreateRNNDataDescriptorResponse res {
		rnnDataDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateRNNDataDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyRNNDataDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyRNNDataDescriptor(
		args->rnnDataDesc
...
void TallyServer::handle_cudnnRNNForward(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRNNForward(
		args->handle,
		args->rnnDesc,
		args->fwdMode,
		args->devSeqLengths,
...
void TallyServer::handle_cudnnSetRNNAlgorithmDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetRNNAlgorithmDescriptor(
		args->handle,
		args->rnnDesc,
		args->algoDesc
...
void TallyServer::handle_cudnnGetRNNForwardInferenceAlgorithmMaxCount(void *__args)
{
	...
	int  count;
	cudnnStatus_t err = cudnnGetRNNForwardInferenceAlgorithmMaxCount(args->handle, args->rnnDesc, (args->count ? &(count) : NULL));
	struct cudnnGetRNNForwardInferenceAlgorithmMaxCountResponse res {
		count,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetRNNForwardInferenceAlgorithmMaxCountResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCreateSeqDataDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateSeqDataDescriptor((args->seqDataDesc ? &(seqDataDesc) : NULL));
	struct cudnnCreateSeqDataDescriptorResponse res {
		seqDataDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateSeqDataDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroySeqDataDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroySeqDataDescriptor(
		args->seqDataDesc
...
void TallyServer::handle_cudnnCreateAttnDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateAttnDescriptor((args->attnDesc ? &(attnDesc) : NULL));
	struct cudnnCreateAttnDescriptorResponse res {
		attnDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateAttnDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyAttnDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyAttnDescriptor(
		args->attnDesc
...
void TallyServer::handle_cudnnSetAttnDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnSetAttnDescriptor(
		args->attnDesc,
		args->attnMode,
		args->nHeads,
		args->smScaler,
...
void TallyServer::handle_cudnnGetMultiHeadAttnBuffers(void *__args)
{
	...
	cudnnStatus_t err = cudnnGetMultiHeadAttnBuffers(args->handle, args->attnDesc, (args->weightSizeInBytes ? &(weightSizeInBytes) : NULL), (args->workSpaceSizeInBytes ? &(workSpaceSizeInBytes) : NULL), (args->reserveSpaceSizeInBytes ? &(reserveSpaceSizeInBytes) : NULL));
	struct cudnnGetMultiHeadAttnBuffersResponse res {
		weightSizeInBytes,
		workSpaceSizeInBytes,
		reserveSpaceSizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetMultiHeadAttnBuffersResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnAdvInferVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnAdvInferVersionCheck(
...
void TallyServer::handle_cudnnRNNBackwardData_v8(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRNNBackwardData_v8(
		args->handle,
		args->rnnDesc,
		args->devSeqLengths,
		args->yDesc,
...
void TallyServer::handle_cudnnRNNBackwardWeights_v8(void *__args)
{
    ...
    cudnnStatus_t err = cudnnRNNBackwardWeights_v8(
		args->handle,
		args->rnnDesc,
		args->addGrad,
		args->devSeqLengths,
...
void TallyServer::handle_cudnnAdvTrainVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnAdvTrainVersionCheck(
...
void TallyServer::handle_cudnnCreateConvolutionDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnCreateConvolutionDescriptor((args->convDesc ? &(convDesc) : NULL));
	struct cudnnCreateConvolutionDescriptorResponse res {
		convDesc,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnCreateConvolutionDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnDestroyConvolutionDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnDestroyConvolutionDescriptor(
		args->convDesc
...
void TallyServer::handle_cudnnGetConvolutionForwardWorkspaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetConvolutionForwardWorkspaceSize(args->handle, args->xDesc, args->wDesc, args->convDesc, args->yDesc, args->algo, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnGetConvolutionForwardWorkspaceSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetConvolutionForwardWorkspaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetConvolutionBackwardDataAlgorithmMaxCount(void *__args)
{
	...
	int  count;
	cudnnStatus_t err = cudnnGetConvolutionBackwardDataAlgorithmMaxCount(args->handle, (args->count ? &(count) : NULL));
	struct cudnnGetConvolutionBackwardDataAlgorithmMaxCountResponse res {
		count,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetConvolutionBackwardDataAlgorithmMaxCountResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetConvolutionBackwardDataWorkspaceSize(void *__args)
{
	...
	size_t  sizeInBytes;
	cudnnStatus_t err = cudnnGetConvolutionBackwardDataWorkspaceSize(args->handle, args->wDesc, args->dyDesc, args->convDesc, args->dxDesc, args->algo, (args->sizeInBytes ? &(sizeInBytes) : NULL));
	struct cudnnGetConvolutionBackwardDataWorkspaceSizeResponse res {
		sizeInBytes,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetConvolutionBackwardDataWorkspaceSizeResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnGetFoldedConvBackwardDataDescriptors(void *__args)
{
    ...
    cudnnStatus_t err = cudnnGetFoldedConvBackwardDataDescriptors(
		args->handle,
		args->filterDesc,
		args->diffDesc,
		args->convDesc,
...
void TallyServer::handle_cudnnCnnInferVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnCnnInferVersionCheck(
...
void TallyServer::handle_cudnnGetConvolutionBackwardFilterAlgorithmMaxCount(void *__args)
{
	...
	int  count;
	cudnnStatus_t err = cudnnGetConvolutionBackwardFilterAlgorithmMaxCount(args->handle, (args->count ? &(count) : NULL));
	struct cudnnGetConvolutionBackwardFilterAlgorithmMaxCountResponse res {
		count,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnGetConvolutionBackwardFilterAlgorithmMaxCountResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnCnnTrainVersionCheck(void *__args)
{
    ...
    cudnnStatus_t err = cudnnCnnTrainVersionCheck(
...
void TallyServer::handle_cudnnBackendCreateDescriptor(void *__args)
{
	...
	cudnnStatus_t err = cudnnBackendCreateDescriptor(args->descriptorType, (args->descriptor ? &(descriptor) : NULL));
	struct cudnnBackendCreateDescriptorResponse res {
		descriptor,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cudnnBackendCreateDescriptorResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cudnnBackendDestroyDescriptor(void *__args)
{
    ...
    cudnnStatus_t err = cudnnBackendDestroyDescriptor(
		args->descriptor
...
void TallyServer::handle_cudnnBackendInitialize(void *__args)
{
    ...
    cudnnStatus_t err = cudnnBackendInitialize(
		args->descriptor
...
void TallyServer::handle_cudnnBackendFinalize(void *__args)
{
    ...
    cudnnStatus_t err = cudnnBackendFinalize(
		args->descriptor
...
void TallyServer::handle_cudnnBackendExecute(void *__args)
{
    ...
    cudnnStatus_t err = cudnnBackendExecute(
		args->handle,
		args->executionPlan,
		args->variantPack
...
void TallyServer::handle_cublasCreate_v2(void *__args)
{
	...
	cublasStatus_t err = cublasCreate_v2((args->handle ? &(handle) : NULL));
...
void TallyServer::handle_cublasGetVersion_v2(void *__args)
{
	...
	int version;
	cublasStatus_t err = cublasGetVersion_v2(args->handle, (args->version ? &(version) : NULL));
...
void TallyServer::handle_cublasGetProperty(void *__args)
{
	...
	int value;
	cublasStatus_t err = cublasGetProperty(args->type, (args->value ? &(value) : NULL));
	struct cublasGetPropertyResponse res {
		value,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cublasGetPropertyResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cublasGetStream_v2(void *__args)
{
	...
	cudaStream_t streamId;
	cublasStatus_t err = cublasGetStream_v2(args->handle, (args->streamId ? &(streamId) : NULL));
	struct cublasGetStream_v2Response res {
		streamId,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cublasGetStream_v2Response))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cublasGetPointerMode_v2(void *__args)
{
	...
	cublasStatus_t err = cublasGetPointerMode_v2(args->handle, (args->mode ? &(mode) : NULL));
	struct cublasGetPointerMode_v2Response res {
		mode,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cublasGetPointerMode_v2Response))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cublasSetPointerMode_v2(void *__args)
{
    ...
    cublasStatus_t err = cublasSetPointerMode_v2(
		args->handle,
		args->mode
...
void TallyServer::handle_cublasGetSmCountTarget(void *__args)
{
	...
	int smCountTarget;
	cublasStatus_t err = cublasGetSmCountTarget(args->handle, (args->smCountTarget ? &(smCountTarget) : NULL));
	struct cublasGetSmCountTargetResponse res {
		smCountTarget,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cublasGetSmCountTargetResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cublasSetSmCountTarget(void *__args)
{
    ...
    cublasStatus_t err = cublasSetSmCountTarget(
		args->handle,
		args->smCountTarget
...
void TallyServer::handle_cublasSetLoggerCallback(void *__args)
{
    ...
    cublasStatus_t err = cublasSetLoggerCallback(
		args->userCallback
...
void TallyServer::handle_cublasGetLoggerCallback(void *__args)
{
	...
	cublasStatus_t err = cublasGetLoggerCallback((args->userCallback ? &(userCallback) : NULL));
	struct cublasGetLoggerCallbackResponse res {
		userCallback,
		err};

    while(!send_ipc->send((void *) &res, sizeof(struct cublasGetLoggerCallbackResponse))) {
        send_ipc->wait_for_recv(1);
    }
}
...
void TallyServer::handle_cublasSetVector(void *__args)
{
    ...
    cublasStatus_t err = cublasSetVector(
		args->n,
		args->elemSize,
		args->x,
		args->incx,
...
void TallyServer::handle_cublasLtCreate(void *__args)
{
	...
	cublasStatus_t err = cublasLtCreate((args->lightHandle ? &(lightHandle) : NULL));
...
void TallyServer::handle_cublasLtGetCudartVersion(void *__args)
{
    ...
    size_t err = cublasLtGetCudartVersion(
...
void TallyServer::handle_cublasLtMatrixLayoutCreate(void *__args)
{
	...
	cublasStatus_t err = cublasLtMatrixLayoutCreate((args->matLayout ? &(matLayout) : NULL), args->type, args->rows, args->cols, args->ld);
...
void TallyServer::handle_cublasLtMatmulDescCreate(void *__args)
{
	...
	cublasStatus_t err = cublasLtMatmulDescCreate((args->matmulDesc ? &(matmulDesc) : NULL), args->computeType, args->scaleType);
...
void TallyServer::handle_cublasLtMatmulPreferenceCreate(void *__args)
{
	...
	cublasStatus_t err = cublasLtMatmulPreferenceCreate((args->pref ? &(pref) : NULL));
...
void TallyServer::handle_cublasLtLoggerForceDisable(void *__args)
{
    ...
    cublasStatus_t err = cublasLtLoggerForceDisable(
