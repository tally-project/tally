            ...
            for (auto &k2_config : k2_configs) {
                ...
                if (!found_in_cache) {
                    ...
                    if ((k1_config != CudaLaunchConfig::default_config) || (k2_config != CudaLaunchConfig::default_config)) {
                        ...
                        std::thread fixed_workload_t_1(launch_kernel_func, 0, CudaLaunchConfig::default_config, 10000, nullptr, nullptr, &(errs[0]), iters[0]);
                        std::thread fixed_workload_t_2(launch_kernel_func, 1, CudaLaunchConfig::default_config, 10000, nullptr, nullptr, &(errs[1]), iters[1]);
