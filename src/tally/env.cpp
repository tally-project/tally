...
float PRIORITY_FALL_BACK_TO_ORIGINAL_THRESHOLD_FOR_SHORT_KERNEL;
...
bool PRIORITY_DISABLE_TRANSFORMATION;
float PRIORITY_SPACE_SHARE_MAX_SM_PERCENTAGE;
...
void __attribute__((constructor)) register_env_vars()
{
    if (!TALLY_INITIALIZED) {
        ...
        REGISTER_FLOAT_ENV_VAR(PRIORITY_FALL_BACK_TO_ORIGINAL_THRESHOLD_FOR_SHORT_KERNEL, 0.5f);
        ...
        REGISTER_FLOAT_ENV_VAR(PRIORITY_MIN_WAIT_TIME_MS, 0.1f);
        REGISTER_FLOAT_ENV_VAR(PRIORITY_WAIT_TIME_MS_TO_USE_ORIGINAL_CONFIGS, 100.f);
        REGISTER_FLOAT_ENV_VAR(PRIORITY_SPACE_SHARE_MAX_SM_PERCENTAGE, 0.f);
        ...
        REGISTER_BOOL_ENV_VAR(PRIORITY_DISABLE_TRANSFORMATION, false);
